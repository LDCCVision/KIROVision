...
# Set the class name
__C.YOLO.CLASSES                = "../data/classes/label.txt"
...
__C.YOLO.DEMO_WEIGHT            = "../checkpoint/yolov3_test_loss=1.7755.ckpt-44"
...
__C.TEST.WEIGHT_FILE            = "../checkpoint/yolov3_test_loss=1.7755.ckpt-44"
